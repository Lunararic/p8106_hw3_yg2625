...
# (c) Compute the confusion matrix and overall fraction of correct predictions. Briey explain what the confusion matrix is telling you.
```{r}
...
# (g) Repeat (e) using KNN. Briey discuss your results.
```{r}
